...
package com.modcom.myappobdmax;
...
public class ChatService {
	...
	public synchronized void connect(BluetoothDevice device, boolean secure) throws IOException {
		// Cancel any thread
	...
	private class ConnectThread extends Thread {
		...
		public ConnectThread(BluetoothDevice device, boolean secure) throws IOException {
			this.device = device;
